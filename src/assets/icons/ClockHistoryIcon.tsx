...
<svg fill="grey" width="800px" height="800px" viewBox="-1 0 16 16" id="historical-sumary-16px" xmlns="http://www.w3.org/2000/svg">
...
const ClockHistoryIcon = ({style}: IconProps) => {
  return (
...
export default React.memo(ClockHistoryIcon);
